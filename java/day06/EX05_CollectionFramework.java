...
public class EX05_CollectionFramework {
    public static void main(String[] args) {
        ...
        * */
         ...
         * 해당 객체가 있는지를 Objects.equals(o1, o2)을 이용하여 확인
        ...
        // remove는 메서드 오버로딩에 의해 2개가 있음, 하나는 객체, 하나는 정수
        // 아래에서 형변환없이 2를 넣으면 2번지에 있는 객체를 삭제
        list.remove((Integer) 2);
        System.out.println(list);

        System.out.println("리스트에 1이 있습니까? : " + list.contains(1));
        System.out.println("리스트에 1이 어디 있습니까? : " + list.indexOf(1));
        ...
        hs.remove(2);
        System.out.println(hs);
        System.out.println("set에 2가 있습니까? " + hs.contains(2));
        System.out.println("set의 크기는? " + hs.size());
        ...
        map.put("abc123", "123123"); // k값이 중복되면 v만 업데이트
