...
public class EX01_Object {
    public static void main(String[] args) {
        /* Object p.360
         * - 모든 클래스의 최상위 조상이 되는 킄래스
         * - Object에 있는 메소드를 사용 또는 오버라이딩 하여 사용할 수 있다
         *
         * equals(클래스명 객체)
         * - 객체를 비교할 때 사용하는 메서드
...
class Car {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(carName, car.carName) && year == car.year;
        // ㅊ파명이 있고, 차명의 비교대상 차명이 같고 연식이 같으면 참 아니면 거짓
        // return carName != null && carName.equals(o.carName) && year == o.year;

    }

    @Override
    public int hashCode() {
        return Objects.hash(carName, year);
    }
