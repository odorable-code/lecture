...
public class EX06_Inheritance {
    public static void main(String[] args) {
        /* 클래스 상속 p.242
         * - 클래스를 돌려 받는 것
         * - 부모 클래스의 필드, 메서드를 물려받는 것
         * - 왜 사용?
         *    - 상속을 통해 코드의 중복을 제거
         *    - 다양성을 통해 여러 객체를 관리할 수 있음
         * - 상속은 is a 관계
         ...
         *    - A는 B를 가지고 잇다가 성립하면 A 클래스의 필드로 B를 선언
         *    - 스마트폰은 카메라를 가지고 있다 (o)
         *    - 스마트폰 : 클래스, 카메라 : 필드
         * - 상속하는 방법
         *    - 부모클래스가 선언되어 있음
         ...
         *        //생성자 추가
         * }
         * - 상속을 받으면 부모클래스의 모든 필드와 메서드를 사용할 수 있다? : X
         *    => private으로 된 필드/메서드는 사용할 수 없음
         *
         * - super 객체
         *    - 부모를 가르키는 객체
...
class Rect extends Shape {
    ...
    public void draw() {
        // 사각형을 그립니다를 출력 후 왼쪽위의 점과 오른쪽 아래점을 출력
        super.draw();
