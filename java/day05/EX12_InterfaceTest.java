...
public class EX12_InterfaceTest {
    public static void main(String[] args) {
         ...
         * MyStudent에는 int compareTo(MyStudent my) 라는 메소드가 없음
         * => 그렇다고 직접 compareTo를 만들어도 안됨
         * => Comparable 인터페이스에 있는 compareTo를 원함 (매개변수의 다형성)
         * */
        stds[0] = new MyStudent(1, 2, 3);
        stds[1] = new MyStudent(1, 1, 4);
        stds[2] = new MyStudent(1, 1, 2);
        stds[3] = new MyStudent(1, 1, 3);
...
class MyStudent implements Comparable<MyStudent> {
    ...
    public int compareTo(MyStudent other) {
        ...
        if (this.classNum != other.classNum) {
            return this.classNum - other.classNum;
        }
