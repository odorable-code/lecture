...
public class EX08_Operator2 {
    public static void main(String[] args) {
        ...
        *
        * */
        // 성적이 90 이상 100 이하이면 A일 때 &&, ||, ! 중에 어떤 연산을 써야 할까요?
        // 정답은 &&. 성적 >= 90 && 성적 <= 100 == A
        ...
        System.out.println("영어회화 이수 : " + passEnglish);
        ...
        *   - 논리 연산자로 연산할 때 발생
        *   - 속도 향상
        *   - || 연산 : 하나라도 참이면 참 => 앞이 참이면 뒤에 식은 볼 필요도 없음
        *   - && 연산 : 하나라도 거짓이면 거짓 => 앞 식이 거짓이면 뒤 식은 볼 필요 없음
         */
        int num1 = 70, num2 = 50;
        System.out.println("num1과 num2 중 하나라도 60이상입니까? " + (num1 >= 60 || (num2 = 60) >= 60) );
        ...
        /* 비트 연산자
         * - 비트 논리 연산자
         *  - 정수를 2비트로 표현한 후 각 비트를 나열하여 논리연산
         *  - 1: true, 0: false
         *  - |, &, ~, ^(XOR)
         *      - | : or
         *      - & : and
         ...
         *  - a << n : 정수 a를 n비트씩 왼쪽으로 이동, 2^n 곱한 효과
         *  - 4 << 3 : 4 * 2^3 => 4 * 8 => 32
         *  - a >> n : n비트씩 오른쪽으로 이동, 2^n 나눈 효과. 이동후 빈 왼쪽은 부호 비트로 채움
         *  - a >>> n : n 비트씩 오른쪽으로 이동. 이동 후 빈 왼쪽은 0으로 채움
         */
        /*
        *  12: 00001100
        *  10: 00001010
